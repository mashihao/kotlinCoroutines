 ...
 * hei hei hei
 */
public class SwitchView extends android.view.View {
    ...
    private final android.view.animation.AccelerateInterpolator interpolator = new android.view.animation.AccelerateInterpolator(2);
    private final android.graphics.Paint paint = new android.graphics.Paint();
    private final android.graphics.Path sPath = new android.graphics.Path();
    private final android.graphics.Path bPath = new android.graphics.Path();
    private final android.graphics.RectF bRectF = new android.graphics.RectF();
    ...
    protected int colorBarOpen;
    protected int colorBarClose;
    ...
    public SwitchView(android.content.Context context) {
        this(context, null);
    }

    @android.annotation.TargetApi(android.os.Build.VERSION_CODES.HONEYCOMB)
    public SwitchView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        ...
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwitchView);
        ...
        colorBarOpen = a.getColor(R.styleable.SwitchView_barColorOpen, 0xFFFFFFFF);
        colorBarClose = a.getColor(R.styleable.SwitchView_barColorClose, 0xFFFFFFFF);
        ...
        if (colorPrimary == DEFAULT_COLOR_PRIMARY && colorPrimaryDark == DEFAULT_COLOR_PRIMARY_DARK) {
            try {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                    android.util.TypedValue primaryColorTypedValue = new android.util.TypedValue();
                    ...
                    android.util.TypedValue primaryColorDarkTypedValue = new android.util.TypedValue();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isCanVisibleDrawing) {
            ...
            sPath.reset();
            android.graphics.RectF sRectF = new android.graphics.RectF();
            sRectF.top = sTop;
            ...
            shadowGradient = new android.graphics.RadialGradient(bCenterX, bCenterY, bRadius, android.graphics.Color.argb(200, red, green, blue),
                    android.graphics.Color.argb(25, red, green, blue), android.graphics.Shader.TileMode.CLAMP);
        }
    }
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        paint.setStyle(android.graphics.Paint.Style.FILL);
        paint.setColor(isOn ? colorBarOpen : colorBarClose);
        canvas.drawPath(bPath, paint);
